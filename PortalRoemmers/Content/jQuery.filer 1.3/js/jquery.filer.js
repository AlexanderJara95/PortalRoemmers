...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        templates: {
            ...
            item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:60}}</div><div class="jFiler-item-others"><span>tama&ntildeo: {{fi-size2}}</span><span>tipo: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
            itemAppend: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title">{{fi-name | limitTo:65}}</div><div class="jFiler-item-others"><span>tama&ntildeo: {{fi-size2}}</span><span>tipo: {{fi-extension}}</span><span class="jFiler-item-status"></span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
        ...
        captions: {
            ...
            removeConfirmation: "Estas seguro de que quieres eliminar este archivo?",
            errors: {
                filesLimit: "Solo se pueden cargar archivos {{fi-limit}} ",
                filesType: "Solo se pueden subir imágenes.",
                filesSize: "! {{fi-name}} es demasiado grande! Sube el archivo hasta {{fi-fileMaxSize}} MB.",
                filesSizeAll: "!Los archivos que ha elegido son demasiado grandes! Cargue archivos de hasta {{fi-maxSize}} MB.",
                folderUpload: "No tiene permiso para cargar carpetas."
            }
        }
    }
})(jQuery);
